...
NotebookDataLength[    421633,       8224]
NotebookOptionsPosition[    419037,       8189]
NotebookOutlinePosition[    419374,       8204]
CellTagsIndexPosition[    419331,       8201]
WindowFrame->Normal*)
...
{$CellContext`min, $CellContext`max}]; $CellContext`\[Alpha]EWnum = 
       ...
       1; $CellContext`cqnum = 1; $CellContext`clnum = 1; $CellContext`cq3num = 
       1; $CellContext`cl3num = 1; $CellContext`cvvw[
...
$CellContext`MVznum; $CellContext`MWn = $CellContext`MWnum; $CellContext`MZn = \
$CellContext`MZnum; $CellContext`MVcn = $CellContext`MVcnum; $CellContext`MHn = \
...
$CellContext`cqnum; $CellContext`cln = $CellContext`clnum; $CellContext`cq3n = \
$CellContext`cq3num; $CellContext`cl3n = $CellContext`cl3num; \
$CellContext`vvn = $CellContext`vvnum; $CellContext`cvvwn = \
$CellContext`cvvwnum; $CellContext`cvvvn = $CellContext`cvvvnum; \
$CellContext`chn = $CellContext`chnum; $CellContext`cwtn = \
$CellContext`cwtnum; $CellContext`cvvhhn = $CellContext`cvvhhnum; \
$CellContext`sCn = $CellContext`sCnum; $CellContext`cCn = $CellContext`cCnum; \
$CellContext`sNn = $CellContext`sNnum; $CellContext`cNn = $CellContext`cNnum; \
$CellContext`aan = $CellContext`aanum; $CellContext`een = $CellContext`eenum; \
$CellContext`gstn = $CellContext`gstnum; $CellContext`swtn = \
$CellContext`swtnum; $CellContext`VzWWWidthnum := (($CellContext`MVzn - 
...
$CellContext`eefunc[$CellContext`MHnum, $CellContext`aanum, \
$CellContext`bbnum, $CellContext`cpsinum, $CellContext`d3num, \
$CellContext`d4num, $CellContext`gstnum, $CellContext`MVz, $CellContext`chnum,
               $CellContext`cvvhhnum, $CellContext`cvvwnum, \
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
...
\[IndentingNewLine]##        this is only 1->2 decay modes.                   \
         ##\[IndentingNewLine]##                                              \
                    ##\[IndentingNewLine]#####################################\
#################################\[IndentingNewLine]\[IndentingNewLine]#######\
############################\[IndentingNewLine]## INFORMATION FOR CHINPUTS\
\[IndentingNewLine]###################################\[IndentingNewLine]\
Block chinputs \[IndentingNewLine]    1 ", 
...
\[IndentingNewLine]Block rhoinputs \[IndentingNewLine]    1 ", 
         ...
         ToString[$CellContext`cq3num], " # cq3 \[IndentingNewLine]    7 ", 
         ToString[$CellContext`cl3num], " # cl3 \[IndentingNewLine]    8 ", 
         ToString[$CellContext`chnum], " # ch \[IndentingNewLine]    9 ", 
         ToString[$CellContext`cvvhhnum], 
         " # cvvhh \[IndentingNewLine]   10 ", 
         ToString[$CellContext`cvvvnum], " # cvvv \[IndentingNewLine]   11 ", 
...
(0=own anti)"]),
 ...
 CellChangeTimes->{
  3.792137965362932*^9, 3.7921385120898066`*^9, 3.7921385886904902`*^9, 
   ...
   3.7922109000326366`*^9},
 CellLabel->"Out[52]=",ExpressionUUID->"4d984b01-37dd-4ee4-9d13-e21b861d63ac"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.599759072168405*^9, {3.599759170441674*^9, 3.599759425244849*^9}, {
   ...
   3.614403644505261*^9},ExpressionUUID->"70dcd879-39c5-4361-b61d-\
faab1fe917f8"],
...
$CellContext`cf[$CellContext`gwT, $CellContext`gstnum, $CellContext`cvwT, \
$CellContext`cvvwT, $CellContext`cvvvT, $CellContext`chT, \
$CellContext`cvvhhT, $CellContext`cfT]; $CellContext`cq3num := \
$CellContext`cf[$CellContext`gwT, $CellContext`gstnum, $CellContext`cvwT, \
$CellContext`cvvwT, $CellContext`cvvvT, $CellContext`chT, \
$CellContext`cvvhhT, $CellContext`cfT]; $CellContext`cl3num := \
$CellContext`cf[$CellContext`gwT, $CellContext`gstnum, $CellContext`cvwT, \
$CellContext`cvvwT, $CellContext`cvvvT, $CellContext`chT, \
...
[hep-ph] and \!\(\*SubscriptBox[\(g\), \(V\)]\) = 6.", 15], "Tooltip"]& ]}
 ...
 CellChangeTimes->{3.792137983200344*^9, 3.7921386604195366`*^9},
 CellLabel->
  "Out[2]//TableForm=",ExpressionUUID->"bafa7b63-b327-4604-aa25-234e897243c2"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.599759563952448*^9, 3.5997596299861193`*^9}, {
  ...
  3.599762291952581*^9, 3.599762310230094*^9}},
      ...
      TagBox[GridBox[{
         ...
         {"\<\"\\!\\(\\*SubscriptBox[\\(c\\), \\(l\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`clnum],
           ContinuousAction->True]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(c\\), \\(q3\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`cq3num],
           ContinuousAction->True]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(c\\), \\(l3\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`cl3num],
           ContinuousAction->True]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(c\\), \\(VVW\\)]\\) = \"\>", 
...
\"\>", 
   ...
   Function[BoxForm`e$, 
    TableForm[BoxForm`e$]]], TraditionalForm]], "Output",
 CellChangeTimes->{3.792138041328337*^9, 3.7921386162762747`*^9, 
  3.792138660485429*^9},
 CellLabel->
  "Out[3]//TableForm=",ExpressionUUID->"12c99b6a-84fa-495d-8bff-beeadc001da3"],
...
($CellContext`VzuubarWidthnum/$CellContext`MVznum) (4 Pi^2/
          3) $CellContext`DY\[Rho]0uu100Func[$CellContext`MVznum/
           1000] + ($CellContext`VzddbarWidthnum/$CellContext`MVznum) (4 Pi^2/
          3) $CellContext`DY\[Rho]0dd100Func[$CellContext`MVznum/1000]; Null),
...
parameters.", 15], "Tooltip"]& ], TraditionalForm]], "Output",
 CellChangeTimes->{3.7921380893723307`*^9, 3.792139566561187*^9, 
  3.792139601814681*^9, 3.7921400560935497`*^9, 3.7921401256840076`*^9, 
  3.792140192570799*^9, 3.7921402536618805`*^9, 3.792140305219243*^9, 
  3.7921404260465775`*^9, 3.7921404614248734`*^9},
 CellLabel->"Out[24]=",ExpressionUUID->"ebe19723-7a5a-4b3f-8e4b-ba82922d8211"],
...
\\*OverscriptBox[\\(\[Tau]\\), \\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vzl3l3barWidthnum],
           ContinuousAction->True,
           Enabled->False]},
...
\\(\\!\\(\\*SubscriptBox[\\(\[Nu]\\), \\(\[Tau]\\)]\\) \
\\*OverscriptBox[\\(\\!\\(\\*SubscriptBox[\\(\[Nu]\\), \\(\[Tau]\\)]\\)\\), \
\\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vznu3nu3barWidthnum],
           ContinuousAction->True,
           Enabled->False]},
...
\\*OverscriptBox[\\(\\!\\(\\*SubscriptBox[\\(\[Nu]\\), \\(\[Tau]\\)]\\)\\), \
\\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vcl3nu3barWidthnum],
           ContinuousAction->True,
           Enabled->False]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(\[CapitalGamma]\\), \\(u \
\\*OverscriptBox[\\(d\\), \\(_\\)]\\)]\\) = \"\>", 
...
\[Tau]\\), \\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vzl3l3barBRnum],
           ContinuousAction->True,
           Enabled->False]},
...
\[Nu]\\), \\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`VznunubarBRnum],
           ContinuousAction->True,
           Enabled->False]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(BR\\), \\(\\!\\(\\*SubscriptBox[\\(\
\[Nu]\\), \\(\[Tau]\\)]\\) \\*OverscriptBox[\\(\\!\\(\\*SubscriptBox[\\(\[Nu]\
\\), \\(\[Tau]\\)]\\)\\), \\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vznu3nu3barBRnum],
           ContinuousAction->True,
           Enabled->False]},
...
\\), \\(_\\)]\\)]\\) = \"\>", 
         ...
         {"\<\"\\!\\(\\*SubscriptBox[\\(BR\\), \\(\[Tau] \\*OverscriptBox[\\(\
\[Nu]\\), \\(_\\)]\\)]\\) = \"\>", 
          InputFieldBox[Dynamic[$CellContext`Vcl3nu3barBRnum],
           ContinuousAction->True,
           Enabled->False]},
...
\>", 
 ...
 CellChangeTimes->{3.7921380893723307`*^9, 3.792139566561187*^9, 
  3.792139601814681*^9, 3.7921400560935497`*^9, 3.7921401256840076`*^9, 
  3.792140192570799*^9, 3.7921402536618805`*^9, 3.792140305219243*^9, 
  3.7921404260465775`*^9, 3.7921404614348583`*^9},
 CellLabel->
  "Out[25]//TableForm=",ExpressionUUID->"1d98acd7-4311-42b4-8fc8-\
2834e3d57d75"],
...
{$CellContext`CSmin, $CellContext`CSmax}}, InterpolationOrder -> 2, Frame -> 
 ...
 CellChangeTimes->{3.7921381079595366`*^9, 3.79220927755968*^9},
 CellLabel->
  "Out[26]//TableForm=",ExpressionUUID->"574b8212-6735-4e62-bf65-\
48f17b1791d6"],
...
{$CellContext`CSmin, $CellContext`CSmax}}, InterpolationOrder -> 2, Frame -> 
 ...
 CellLabel->
  "Out[27]//TableForm=",ExpressionUUID->"d9e8def4-a9c0-4537-91fd-\
fb32e01006c5"],
...
{$CellContext`CSmin, $CellContext`CSmax}}, InterpolationOrder -> 2, Frame -> 
 ...
 CellLabel->
  "Out[28]//TableForm=",ExpressionUUID->"d5ac07b4-e13f-4a0a-be24-\
99e2a508cb10"],
...
{$CellContext`CSmin, $CellContext`CSmax}}, InterpolationOrder -> 2, Frame -> 
 ...
 CellLabel->
  "Out[29]//TableForm=",ExpressionUUID->"ec85dbfa-5a5e-485d-8c8e-\
e65ea68ddbb0"],
...
Cell[3073, 71, 268176, 4826, 56, "Output",ExpressionUUID->"4d984b01-37dd-4ee4-9d13-e21b861d63ac"],
Cell[271252, 4899, 308, 6, 38, "Text",ExpressionUUID->"90b96085-1a33-4bbd-93c2-ec01d545e68f"],
Cell[271563, 4907, 5827, 248, 65, "Text",ExpressionUUID->"70dcd879-39c5-4361-b61d-faab1fe917f8"],
Cell[277393, 5157, 6210, 219, 116, "Text",ExpressionUUID->"b375a357-e820-4bbd-af14-64a12d68db49"],
Cell[283606, 5378, 1988, 42, 64, "Text",ExpressionUUID->"001e1001-0f47-4904-8702-c6ea9cda89f2"],
Cell[285597, 5422, 308, 6, 38, "Text",ExpressionUUID->"7d03bc84-8d20-4ecc-a9c6-5ca8640a3498"],
Cell[285908, 5430, 12227, 224, 107, "Output",ExpressionUUID->"bafa7b63-b327-4604-aa25-234e897243c2"],
Cell[298138, 5656, 308, 6, 38, "Text",ExpressionUUID->"b4c0bedd-fcbd-4a17-b68d-64f9f8f1f01f"],
Cell[298449, 5664, 1592, 29, 82, "Text",ExpressionUUID->"51072543-8e28-4f27-b12d-bab4de4f2180"],
Cell[300044, 5695, 308, 6, 38, "Text",ExpressionUUID->"2d42e650-8581-4a31-b87c-65824f65dae3"],
Cell[300355, 5703, 9308, 209, 647, "Output",ExpressionUUID->"12c99b6a-84fa-495d-8bff-beeadc001da3"],
Cell[309666, 5914, 308, 6, 38, "Text",ExpressionUUID->"3cf160d8-ae36-4d2a-b5fe-a82967913418"],
Cell[309977, 5922, 1078, 24, 64, "Text",ExpressionUUID->"817d9722-910d-4ba0-9128-e24d00a1098d"],
Cell[311058, 5948, 308, 6, 38, "Text",ExpressionUUID->"6faf8f76-a3b8-494f-9ac1-c38731bb76ff"],
Cell[311369, 5956, 24756, 420, 54, "Output",ExpressionUUID->"ebe19723-7a5a-4b3f-8e4b-ba82922d8211"],
Cell[336128, 6378, 13643, 306, 531, "Output",ExpressionUUID->"1d98acd7-4311-42b4-8fc8-2834e3d57d75"],
Cell[349774, 6686, 308, 6, 38, "Text",ExpressionUUID->"377976f6-0cce-491a-a542-e97279583f59"],
Cell[350085, 6694, 1818, 37, 64, "Text",ExpressionUUID->"905e3134-04e0-4dd5-8281-a6df7596e1ab"],
Cell[351906, 6733, 308, 6, 38, "Text",ExpressionUUID->"eb65c925-d735-467a-84e1-5ea23a732616"],
Cell[352217, 6741, 15420, 334, 517, "Output",ExpressionUUID->"574b8212-6735-4e62-bf65-48f17b1791d6"],
Cell[367640, 7077, 308, 6, 38, "Text",ExpressionUUID->"64ee17c7-009a-46f2-979c-df51d74fce92"],
Cell[367951, 7085, 16176, 344, 513, "Output",ExpressionUUID->"d9e8def4-a9c0-4537-91fd-fb32e01006c5"],
Cell[384130, 7431, 308, 6, 38, "Text",ExpressionUUID->"01301d5e-765f-4a4a-ad45-e6da9b8e89f3"],
Cell[384441, 7439, 16177, 344, 513, "Output",ExpressionUUID->"d5ac07b4-e13f-4a0a-be24-99e2a508cb10"],
Cell[400621, 7785, 308, 6, 38, "Text",ExpressionUUID->"0d915a1c-955c-4493-8bb5-70861f8d8ae9"],
Cell[400932, 7793, 16219, 342, 513, "Output",ExpressionUUID->"ec85dbfa-5a5e-485d-8c8e-e65ea68ddbb0"],
Cell[417154, 8137, 308, 6, 38, "Text",ExpressionUUID->"c97e2863-8e55-4ffa-91fe-bb1708bbb878"],
Cell[417465, 8145, 501, 12, 36, "Text",ExpressionUUID->"847bebed-5278-4864-aaca-7604f49c8bc6"],
Cell[417969, 8159, 308, 6, 38, "Text",ExpressionUUID->"b7f16918-f051-424c-89e5-1a4b0f4acc1b"],
Cell[418280, 8167, 741, 19, 54, "Output",ExpressionUUID->"2dfb3749-a9d0-41af-9a90-9599b1910341"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature Ex0qFlQ53q4pPDK0nN8UhowB *)
