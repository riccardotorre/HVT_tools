...
$CellContext`clnumscanF = $CellContext`clnum; $CellContext`clnumscanN = 
       0; $CellContext`c3num = 
       1; $CellContext`c3numscanI = $CellContext`c3num; \
$CellContext`c3numscanF = $CellContext`c3num; $CellContext`c3numscanN = 
...
$CellContext`MZn = $CellContext`MZnum; $CellContext`MHn = $CellContext`MHnum; \
$CellContext`gstn = $CellContext`gstnum; $CellContext`chn = \
$CellContext`chnum; $CellContext`cqn = $CellContext`cqnum; $CellContext`cln = \
$CellContext`clnum; $CellContext`c3n = $CellContext`c3num; $CellContext`cvvwn = \
...
$CellContext`MZnum^2)) ($CellContext`gwn^2 - (4 $CellContext`\[Alpha]EWnum) 
            Pi) - 2 Sqrt[($CellContext`gwn^4 ($CellContext`gwn^2 - (
                4 $CellContext`\[Alpha]EWnum) 
...
(((4 $CellContext`\[Alpha]EWnum) $CellContext`gwn^8) ($CellContext`MVzn^2 + \
$CellContext`MZnum^2)) 
          Pi + ((((
...
$CellContext`MWtn^2) $CellContext`vvn^2 + (
             ...
             16 $CellContext`cvvhhn) $CellContext`gstn^2) $CellContext`vvn^2 + 
          16 $CellContext`mVn^2 + 16 $CellContext`MWtn^2]/(4 
        Sqrt[2]); $CellContext`totnumberofpoints = 
...
\\(3\\)]\\)=\\!\\(\\*SubscriptBox[\\(c\\), \\(F\\)]\\)\"\>",
        ...
        FontSize->18],
       Appearance->Automatic,
       ButtonFunction:>($CellContext`constraincF = True),
       Evaluator->Automatic,
       Method->"Queued"], 
      ButtonBox[
       StyleBox["\<\"Un-constrain \\!\\(\\*SubscriptBox[\\(c\\), \\(q\\)]\\)=\
\\!\\(\\*SubscriptBox[\\(c\\), \\(l\\)]\\)=\\!\\(\\*SubscriptBox[\\(c\\), \
\\(3\\)]\\)=\\!\\(\\*SubscriptBox[\\(c\\), \\(F\\)]\\)\"\>",
        StripOnInput->False,
        FontSize->18],
       Appearance->Automatic,
       ButtonFunction:>($CellContext`constraincF = False),
       Evaluator->Automatic,
       Method->"Queued"]}
    },
    GridBoxAlignment->{
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cqnumscanI, 
                 Initialization -> $CellContext`cqnum],
                ContinuousAction->True]}
             },
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cqnumscanF, 
                 Initialization -> $CellContext`cqnum],
                ContinuousAction->True]}
             },
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`clnumscanI, 
                 Initialization -> $CellContext`clnum],
                ContinuousAction->True,
                Enabled->Dynamic[
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`clnumscanF, 
                 Initialization -> $CellContext`cqnum],
                ContinuousAction->True,
                Enabled->Dynamic[
                  Not[$CellContext`constraincF]]]}
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`c3numscanI, 
                 Initialization -> $CellContext`c3num],
                ContinuousAction->True,
                Enabled->Dynamic[
                  Not[$CellContext`constraincF]]]}
             },
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`c3numscanF, 
                 Initialization -> $CellContext`c3num],
                ContinuousAction->True,
                Enabled->Dynamic[
                  Not[$CellContext`constraincF]]]}
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`c3numscanN, Initialization -> 0],
                ContinuousAction->True,
                Enabled->Dynamic[
                  Not[$CellContext`constraincF]]]}
             },
...
$CellContext`c3numstep = If[
       And[$CellContext`c3numscanN != 
        0, $CellContext`c3numscanF - $CellContext`c3numscanI != 
        0], ($CellContext`c3numscanF - \
$CellContext`c3numscanI)/$CellContext`c3numscanN, $CellContext`MVznum]; \
...
$CellContext`totnumberofpoints = If[$CellContext`constraincF, 
       Apply[Times, 
...
$CellContext`gstnum <= $CellContext`gstnumscanF, 
        ...
        For[$CellContext`chnum = $CellContext`chnumscanI, $CellContext`chnum <= \
$CellContext`chnumscanF, 
         AddTo[$CellContext`chnum, $CellContext`chnumstep], 
         For[$CellContext`cqnum = $CellContext`cqnumscanI, $CellContext`cqnum <= \
$CellContext`cqnumscanF, 
...
$CellContext`MVzn = $CellContext`MVznum; $CellContext`MZn = \
$CellContext`MZnum; $CellContext`MHn = $CellContext`MHnum; $CellContext`gstn = \
$CellContext`gstnum; $CellContext`chn = $CellContext`chnum; $CellContext`cqn = \
$CellContext`cqnum; $CellContext`cln = $CellContext`cqnum; $CellContext`c3n = \
$CellContext`cqnum; $CellContext`cvvwn = $CellContext`cvvwnum; \
...
$CellContext`VzWWBRnum, $CellContext`VzhZBRnum, $CellContext`VzuubarBRnum, \
$CellContext`VzddbarBRnum, $CellContext`VzllbarBRnum, \
$CellContext`VznunubarBRnum, $CellContext`VzbbbarBRnum, \
...
$CellContext`clnum <= $CellContext`clnumscanF, 
           ...
           For[$CellContext`c3num = $CellContext`c3numscanI, \
$CellContext`c3num <= $CellContext`c3numscanF, 
            AddTo[$CellContext`c3num, $CellContext`c3numstep], 
...
$CellContext`MZnum; $CellContext`MHn = $CellContext`MHnum; $CellContext`gstn = \
$CellContext`gstnum; $CellContext`chn = $CellContext`chnum; $CellContext`cqn = \
$CellContext`cqnum; $CellContext`cln = $CellContext`clnum; $CellContext`c3n = \
$CellContext`c3num; $CellContext`cvvwn = $CellContext`cvvwnum; \
$CellContext`cvvhhn = $CellContext`cvvhhnum; $CellContext`cvvvn = \
$CellContext`cvvvnum; $CellContext`aan = $CellContext`aanum; $CellContext`gwn = \
$CellContext`gwnum; $CellContext`vvn = 
                Sqrt[(((
...
$CellContext`cvvhhnumscanI)/$CellContext`cvvhhnumstep + 
          1, ($CellContext`cvvvnumscanF - \
$CellContext`cvvvnumscanI)/$CellContext`cvvvnumstep + 1}, 
         1]]]; $CellContext`ScanResultTable13 = {}; $CellContext`indicator13 = 
...
$CellContext`VzTotWidthnum; $CellContext`VcTotWidthn = \
$CellContext`VcTotWidthnum; 
             AppendTo[$CellContext`ScanResultTable13, {$CellContext`MVzn, \
$CellContext`MVcn, $CellContext`gwn, $CellContext`gstn, $CellContext`chn, \
$CellContext`cqn, $CellContext`cln, $CellContext`c3n, $CellContext`cvvwn, \
$CellContext`cvvhhn, $CellContext`cvvvn, $CellContext`VzTotWidthnum, \
$CellContext`VzWWBRnum, $CellContext`VzhZBRnum, $CellContext`VzuubarBRnum, \
...
$CellContext`indicator13 + 1; Null]]]]]]], 
      For[$CellContext`MVznum = $CellContext`MVznumscanI, $CellContext`MVznum <= \
$CellContext`MVznumscanF, 
       AddTo[$CellContext`MVznum, $CellContext`MVznumstep], 
       For[$CellContext`gstnum = $CellContext`gstnumscanI, \
...
$CellContext`indicator13 + 1; 
               Null]]]]]]]]]]; $CellContext`ScanResultTableToPrint13 = 
