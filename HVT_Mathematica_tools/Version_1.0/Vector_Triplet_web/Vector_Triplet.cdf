...
NotebookDataLength[    412594,       8096]
NotebookOptionsPosition[    411659,       8053]
NotebookOutlinePosition[    412197,       8076]
CellTagsIndexPosition[    412154,       8073]
WindowFrame->Normal*)
...
$CellContext`cvwT) ($CellContext`cvvwT + 
          2) + (2 ($CellContext`gw^4/$CellContext`gst^4)) \
$CellContext`cvwT^3); $CellContext`ch[
         Pattern[$CellContext`gw, 
          Blank[]], 
         Pattern[$CellContext`gst, 
          Blank[]], 
...
($CellContext`cfT + $CellContext`cvwT); $CellContext`gwfunc[
       ...
       Sqrt[(2 ((
             16 (((4 Sqrt[
                  2]) $CellContext`Gfnum^6) $CellContext`MZnum^16 - (((
                 44 $CellContext`\[Alpha]EWnum) $CellContext`Gfnum^5) 
               Pi) $CellContext`MZnum^14 + ((((83 
                   Sqrt[2]) $CellContext`\[Alpha]EWnum^2) \
$CellContext`Gfnum^4) 
                Pi^2) $CellContext`MZnum^12 - (((
                 120 $CellContext`\[Alpha]EWnum^3) $CellContext`Gfnum^3) 
               Pi^3) $CellContext`MZnum^10 + ((((24 
                   Sqrt[2]) $CellContext`\[Alpha]EWnum^4) \
$CellContext`Gfnum^2) 
...
($CellContext`Gfnum $CellContext`MZnum^2 - ((2 
                    Sqrt[2]) $CellContext`\[Alpha]EWnum) Pi)]) + (51 Sqrt[2]) 
...
$CellContext`MZnum^12 - ((((5 
              ...
              Pi^3) $CellContext`MZnum^6 + ($CellContext`\[Alpha]EWnum 
               Pi) (($CellContext`\[Alpha]EWnum Pi) (
                 9 Sqrt[($CellContext`Gfnum^5 $CellContext`MZnum^14) \
($CellContext`Gfnum $CellContext`MZnum^2 - ((2 
...
$CellContext`MVz^4) (((((8 
                  Sqrt[2]) $CellContext`\[Alpha]EWnum^2) $CellContext`Gfnum) 
               Pi^2) (($CellContext`Gfnum^2 $CellContext`MZnum^12) \
($CellContext`Gfnum^2 $CellContext`MZnum^4 - ((((4 
                    Sqrt[2]) $CellContext`\[Alpha]EWnum) $CellContext`Gfnum) 
                  Pi) $CellContext`MZnum^2 + (8 $CellContext`\[Alpha]EWnum^2) 
                  Pi^2))^(1/4) + (
               Sqrt[2] $CellContext`Gfnum^4) $CellContext`MZnum^8 + ((((8 
                  Sqrt[2]) $CellContext`\[Alpha]EWnum^2) \
$CellContext`Gfnum^2) $CellContext`MZnum^4) 
              Pi^2 - ((8 $CellContext`\[Alpha]EWnum) Pi) 
...
$CellContext`MZnum^6) 
             Pi)))/(((($CellContext`Gfnum $CellContext`gst^4) \
$CellContext`MVz^4) $CellContext`MZnum^2) ($CellContext`Gfnum \
$CellContext`MZnum^2 - ((2 Sqrt[2]) $CellContext`\[Alpha]EWnum) 
           Pi)^2)]; $CellContext`vvfunc[
         Pattern[$CellContext`MH, 
          Blank[]], 
         Pattern[$CellContext`aa, 
          Blank[]], 
...
$CellContext`cc, $CellContext`d3, $CellContext`d4, $CellContext`gst, \
$CellContext`MVz, $CellContext`ch, $CellContext`cvvhh, $CellContext`cvvw, \
$CellContext`cvvv, $CellContext`cq, $CellContext`cl, $CellContext`c3]^8) \
($CellContext`MVz^2 + $CellContext`MZnum^2)) 
          Pi + ((((
...
(9 $CellContext`MVzn^2) $CellContext`MWn^2 + 
              ...
              2 $CellContext`cCn^2) $CellContext`gwn) $CellContext`sCn^2) (((
               2 $CellContext`cNn^2) $CellContext`gwn) ($CellContext`MVzn^4 + \
((11 + 8 $CellContext`cvvwn + $CellContext`cvvwn^2) $CellContext`MVzn^2) \
$CellContext`MWn^2 + (
...
$CellContext`sNn^2 + (((((((
                  2 $CellContext`cln) $CellContext`cNn) $CellContext`cwtn^3) \
$CellContext`een) $CellContext`gwn^2) $CellContext`sNn) \
...
$CellContext`swtn^4))/((((288 $CellContext`cwtn^2) $CellContext`MVzn^3) 
         ...
         HeavisideTheta[$CellContext`MVzn - 
           2 $CellContext`MTnum]]; $CellContext`VzTotWidthnum := \
...
$CellContext`MZn^2))^(3/
           2) ((($CellContext`cCn^4 $CellContext`gwn^2) ($CellContext`MVcn^4 + \
...
$CellContext`MVcn^2 (4 $CellContext`MWn^2 + 
        ...
        Pi); $CellContext`VcW\[Gamma]Widthnum := ((((((($CellContext`cCn^2 \
(-1 + $CellContext`cvvwn)^2) $CellContext`gwn^2) ($CellContext`MVcn - \
...
$CellContext`MBnum]]; $CellContext`VcTotWidthnum := $CellContext`VcZWWidthnum + \
$CellContext`VcW\[Gamma]Widthnum + $CellContext`VchWWidthnum + \
$CellContext`VctbbarWidthnum + 2 $CellContext`VcudbarWidthnum + 
        2 $CellContext`VcusbarWidthnum + 
...
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
$CellContext`c3n]^2 + (((((((
                  18 $CellContext`cNfunc[$CellContext`MHnum, \
$CellContext`aanum, $CellContext`bbnum, $CellContext`cpsinum, \
$CellContext`d3num, $CellContext`d4num, $CellContext`gstnum, \
$CellContext`MVz, $CellContext`chnum, $CellContext`cvvhhnum, \
$CellContext`cvvwnum, $CellContext`cvvvnum, $CellContext`cqnum, \
$CellContext`clnum, $CellContext`c3n]) $CellContext`cqnum) \
$CellContext`cwtfunc[$CellContext`MHnum, $CellContext`aanum, \
$CellContext`bbnum, $CellContext`cpsinum, $CellContext`d3num, \
$CellContext`d4num, $CellContext`gstnum, $CellContext`MVz, \
$CellContext`chnum, $CellContext`cvvhhnum, $CellContext`cvvwnum, \
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
$CellContext`c3n]^3) $CellContext`eefunc[$CellContext`MHnum, \
$CellContext`aanum, $CellContext`bbnum, $CellContext`cpsinum, \
$CellContext`d3num, $CellContext`d4num, $CellContext`gstnum, \
$CellContext`MVz, $CellContext`chnum, $CellContext`cvvhhnum, \
$CellContext`cvvwnum, $CellContext`cvvvnum, $CellContext`cqnum, \
...
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
$CellContext`c3n]^2) ((((
                 3 $CellContext`cNfunc[$CellContext`MHnum, \
$CellContext`aanum, $CellContext`bbnum, $CellContext`cpsinum, \
$CellContext`d3num, $CellContext`d4num, $CellContext`gstnum, \
$CellContext`MVz, $CellContext`chnum, $CellContext`cvvhhnum, \
$CellContext`cvvwnum, $CellContext`cvvvnum, $CellContext`cqnum, \
$CellContext`clnum, $CellContext`c3n]^2) $CellContext`cqnum^2) \
$CellContext`gwfunc[$CellContext`MHnum, $CellContext`aanum, \
$CellContext`bbnum, $CellContext`cpsinum, $CellContext`d3num, \
$CellContext`d4num, $CellContext`gstnum, $CellContext`MVz, \
$CellContext`chnum, $CellContext`cvvhhnum, $CellContext`cvvwnum, \
...
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
$CellContext`c3n]^2 - (((((((
                 6 $CellContext`cNfunc[$CellContext`MHnum, \
$CellContext`aanum, $CellContext`bbnum, $CellContext`cpsinum, \
$CellContext`d3num, $CellContext`d4num, $CellContext`gstnum, \
$CellContext`MVz, $CellContext`chnum, $CellContext`cvvhhnum, \
$CellContext`cvvwnum, $CellContext`cvvvnum, $CellContext`cqnum, \
...
$CellContext`chnum, $CellContext`cvvhhnum, $CellContext`cvvwnum, \
$CellContext`cvvvnum, $CellContext`cqnum, $CellContext`clnum, \
$CellContext`c3n]^3)/$CellContext`gstnum + ((
...
(($CellContext`VcudbarWidthfunc[$CellContext`MVz]/$CellContext`MVz) (
         ...
         Pattern[$CellContext`MVz, 
          ...
          Blank[]]] := \
(($CellContext`VzuubarWidthfunc[$CellContext`MVz]/$CellContext`MVz) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0uu100Func[$CellContext`MVz/
           1000] + (($CellContext`VzddbarWidthfunc[$CellContext`MVz]/$\
CellContext`MVz) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0dd100Func[$CellContext`MVz/
...
(($CellContext`VzuubarWidthnum/$CellContext`MVznum) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0uu14Func[$CellContext`MVznum/
           1000] + (($CellContext`VzddbarWidthnum/$CellContext`MVznum) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0dd14Func[$CellContext`MVznum/
...
(($CellContext`VzuubarWidthnum/$CellContext`MVznum) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0uu100Func[$CellContext`MVznum/
           1000] + (($CellContext`VzddbarWidthnum/$CellContext`MVznum) (
           4 (Pi^2/3))) $CellContext`DY\[Rho]0dd100Func[$CellContext`MVznum/
...
", 
         ...
         ToString[$CellContext`M\[Tau]num], " # MTA \n   23 ", 
         ToString[$CellContext`MZnum], " # MZ \[IndentingNewLine]   25 ", 
...
\"\>", 
          InputFieldBox[Dynamic[$CellContext`CSVmDY8TeVnum],
           ContinuousAction->True,
           Enabled->False]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(\[Sigma]\\), \\(+\\)]\\)(13TeV) = \
\"\>", 
          InputFieldBox[Dynamic[$CellContext`CSVpDY13TeVnum],
           ContinuousAction->True,
           Enabled->False]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(\[Sigma]\\), \\(0\\)]\\)(13TeV) = \
\"\>", 
          InputFieldBox[Dynamic[$CellContext`CSV0DY13TeVnum],
           ContinuousAction->True,
           Enabled->False]},
         {"\<\"\\!\\(\\*SubscriptBox[\\(\[Sigma]\\), \\(-\\)]\\)(13TeV) = \
\"\>", 
          InputFieldBox[Dynamic[$CellContext`CSVmDY13TeVnum],
           ContinuousAction->True,
           Enabled->False]},
...
\>",
        ...
        FontSize->18],
       Appearance->Automatic,
       ButtonFunction:>($CellContext`CSVpDY13TeVTabletmp1 = 
         Table[{$CellContext`MM, 
            $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 500,
             1000, 100}]; $CellContext`CSVpDY13TeVTabletmp2 = 
         Table[{$CellContext`MM, 
            $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            2000, 9000, 1000}]; $CellContext`CSVpDY13TeVTabletmp3 = 
         Table[{$CellContext`MM, 
            $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            9000, 10000, 900}]; $CellContext`CSVpDY13TeVTable = 
         Join[$CellContext`CSVpDY13TeVTabletmp1, \
$CellContext`CSVpDY13TeVTabletmp2, $CellContext`CSVpDY13TeVTabletmp3]; \
$CellContext`CSV0DY13TeVTabletmp1 = Table[{$CellContext`MM, 
            $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 500,
             1000, 100}]; $CellContext`CSV0DY13TeVTabletmp2 = 
         Table[{$CellContext`MM, 
            $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            2000, 9000, 1000}]; $CellContext`CSV0DY13TeVTabletmp3 = 
         Table[{$CellContext`MM, 
            $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            9000, 10000, 900}]; $CellContext`CSV0DY13TeVTable = 
         Join[$CellContext`CSV0DY13TeVTabletmp1, \
$CellContext`CSV0DY13TeVTabletmp2, $CellContext`CSV0DY13TeVTabletmp3]; \
$CellContext`CSVmDY13TeVTabletmp1 = Table[{$CellContext`MM, 
            $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 500,
             1000, 100}]; $CellContext`CSVmDY13TeVTabletmp2 = 
         Table[{$CellContext`MM, 
            $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            2000, 9000, 1000}]; $CellContext`CSVmDY13TeVTabletmp3 = 
         Table[{$CellContext`MM, 
            $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 
            9000, 10000, 900}]; $CellContext`CSVmDY13TeVTable = 
         Join[$CellContext`CSVmDY13TeVTabletmp1, \
$CellContext`CSVmDY13TeVTabletmp2, $CellContext`CSVmDY13TeVTabletmp3]),
       Evaluator->Automatic,
       Method->"Queued"]},
     {
      TagBox[
   ...
   TableForm[{{
      Button[
       ...
       "Compute and Plot DY Production Cross Section at 13 TeV", 
        18], $CellContext`CSVpDY13TeVTabletmp1 = Table[{$CellContext`MM, 
           $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 500, 
           1000, 100}]; $CellContext`CSVpDY13TeVTabletmp2 = 
        Table[{$CellContext`MM, 
           $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 2000,
            9000, 1000}]; $CellContext`CSVpDY13TeVTabletmp3 = 
        Table[{$CellContext`MM, 
           $CellContext`CSVpDY13TeV[$CellContext`MM]}, {$CellContext`MM, 9000,
            10000, 900}]; $CellContext`CSVpDY13TeVTable = 
        Join[$CellContext`CSVpDY13TeVTabletmp1, \
$CellContext`CSVpDY13TeVTabletmp2, $CellContext`CSVpDY13TeVTabletmp3]; \
$CellContext`CSV0DY13TeVTabletmp1 = Table[{$CellContext`MM, 
           $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 500, 
           1000, 100}]; $CellContext`CSV0DY13TeVTabletmp2 = 
        Table[{$CellContext`MM, 
           $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 2000,
            9000, 1000}]; $CellContext`CSV0DY13TeVTabletmp3 = 
        Table[{$CellContext`MM, 
           $CellContext`CSV0DY13TeV[$CellContext`MM]}, {$CellContext`MM, 9000,
            10000, 900}]; $CellContext`CSV0DY13TeVTable = 
        Join[$CellContext`CSV0DY13TeVTabletmp1, \
$CellContext`CSV0DY13TeVTabletmp2, $CellContext`CSV0DY13TeVTabletmp3]; \
$CellContext`CSVmDY13TeVTabletmp1 = Table[{$CellContext`MM, 
           $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 500, 
           1000, 100}]; $CellContext`CSVmDY13TeVTabletmp2 = 
        Table[{$CellContext`MM, 
           $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 2000,
            9000, 1000}]; $CellContext`CSVmDY13TeVTabletmp3 = 
        Table[{$CellContext`MM, 
           $CellContext`CSVmDY13TeV[$CellContext`MM]}, {$CellContext`MM, 9000,
            10000, 900}]; $CellContext`CSVmDY13TeVTable = 
        Join[$CellContext`CSVmDY13TeVTabletmp1, \
$CellContext`CSVmDY13TeVTabletmp2, $CellContext`CSVmDY13TeVTabletmp3], Method -> 
       "Queued"]}, 
     TableForm[{
       DynamicModule[{$CellContext`MMmin = 500, $CellContext`MMmax = 
...
$CellContext`CSVmDY14TeVTabletmp1 = Table[{$CellContext`MM, 
        ...
        Table[{$CellContext`MM, 
           $CellContext`CSVmDY14TeV[$CellContext`MM]}, {$CellContext`MM, 9000,
            10000, 900}]; $CellContext`CSVmDY14TeVTable = 
        Join[$CellContext`CSVmDY14TeVTabletmp1, \
$CellContext`CSVmDY14TeVTabletmp2, $CellContext`CSVmDY14TeVTabletmp3], Method -> 
       "Queued"]}, 
     TableForm[{
       DynamicModule[{$CellContext`MMmin = 500, $CellContext`MMmax = 
         10000, $CellContext`CSmin = 1.*^-12, $CellContext`CSmax = 100}, 
...
WindowSize->{1062.4166666666667`, 7344.},
Visible->True,
AuthoredSize->{1062, 7344},
...
Cell[1612, 38, 296, 6, 59, "Subtitle"],
Cell[1911, 46, 291, 4, 45, "Text"],
Cell[2205, 52, 76, 1, 21, "Text"],
Cell[2284, 55, 268912, 4841, 39, "Output"],
Cell[271199, 4898, 76, 1, 21, "Text"],
Cell[271278, 4901, 5326, 239, 71, "Text"],
Cell[276607, 5142, 5690, 210, 85, "Text"],
Cell[282300, 5354, 1371, 32, 97, "Text"],
Cell[283674, 5388, 11403, 212, 79, "Output"],
Cell[295080, 5602, 76, 1, 21, "Text"],
Cell[295159, 5605, 1149, 23, 61, "Text"],
Cell[296311, 5630, 76, 1, 21, "Text"],
Cell[296390, 5633, 9337, 211, 593, "Output"],
Cell[305730, 5846, 76, 1, 21, "Text"],
Cell[305809, 5849, 703, 17, 48, "Text"],
Cell[306515, 5868, 76, 1, 21, "Text"],
Cell[306594, 5871, 23489, 413, 34, "Output"],
Cell[330086, 6286, 12045, 277, 457, "Output"],
Cell[342134, 6565, 76, 1, 21, "Text"],
Cell[342213, 6568, 1225, 27, 100, "Text"],
Cell[343441, 6597, 76, 1, 21, "Text"],
Cell[343520, 6600, 16135, 344, 487, "Output"],
Cell[359658, 6946, 76, 1, 21, "Text"],
Cell[359737, 6949, 16905, 355, 487, "Output"],
Cell[376645, 7306, 76, 1, 21, "Text"],
Cell[376724, 7309, 16905, 355, 487, "Output"],
Cell[393632, 7666, 76, 1, 21, "Text"],
Cell[393711, 7669, 16936, 352, 487, "Output"],
Cell[410650, 8023, 76, 1, 21, "Text"],
Cell[410729, 8026, 144, 4, 22, "Text"],
Cell[410876, 8032, 479, 7, 35, "Text"],
Cell[411358, 8041, 76, 1, 21, "Text"],
Cell[411437, 8044, 206, 6, 3257, "Output"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature Iv0VvtgMM53RWCg12dRibiga *)
