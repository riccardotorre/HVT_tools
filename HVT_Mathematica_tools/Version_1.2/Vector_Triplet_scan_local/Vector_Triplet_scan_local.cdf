...
NotebookDataLength[    598998,      10978]
NotebookOptionsPosition[    597998,      10959]
NotebookOutlinePosition[    598394,      10975]
CellTagsIndexPosition[    598351,      10972]
WindowFrame->Normal*)
...
$CellContext`cl3n]; 
      Clear[$CellContext`gstnscanI, $CellContext`gstnscanF, \
$CellContext`gstnscanN, $CellContext`MVznscanI, $CellContext`MVznscanF, \
$CellContext`MVznscanN, $CellContext`chnscanI, $CellContext`chnscanF, \
$CellContext`chnscanN]; 
      Clear[$CellContext`cqnscanI, $CellContext`cqnscanF, \
$CellContext`cqnscanN, $CellContext`clnscanI, $CellContext`clnscanF, \
$CellContext`clnscanN, $CellContext`cq3nscanI, $CellContext`cq3nscanF, \
$CellContext`cq3nscanN, $CellContext`cl3nscanI, $CellContext`cl3nscanF, \
$CellContext`cl3nscanN]; 
      Clear[$CellContext`cvvwnscanI, $CellContext`cvvwnscanF, \
$CellContext`cvvwnscanN, $CellContext`cvvhhnscanI, $CellContext`cvvhhnscanF, \
$CellContext`cvvhhnscanN, $CellContext`cvvvnscanI, $CellContext`cvvvnscanF, \
$CellContext`cvvvnscanN]; 
...
{$CellContext`min, $CellContext`max}]; $CellContext`\[Alpha]EWn = 
       ...
       1; $CellContext`cl3n = 
       1; $CellContext`gstnscanI = $CellContext`gstn; $CellContext`gstnscanF = \
$CellContext`gstn; $CellContext`gstnscanN = 
       0; $CellContext`MVznscanI = $CellContext`MVzn; $CellContext`MVznscanF = \
$CellContext`MVzn; $CellContext`MVznscanN = 
       0; $CellContext`chnscanI = $CellContext`chn; $CellContext`chnscanF = \
$CellContext`chn; $CellContext`chnscanN = 
       0; $CellContext`cvvhhnscanI = $CellContext`cvvhhn; \
$CellContext`cvvhhnscanF = $CellContext`cvvhhn; $CellContext`cvvhhnscanN = 
       0; $CellContext`cvvwnscanI = $CellContext`cvvwn; \
$CellContext`cvvwnscanF = $CellContext`cvvwn; $CellContext`cvvwnscanN = 
       0; $CellContext`cvvvnscanI = $CellContext`cvvvn; \
$CellContext`cvvvnscanF = $CellContext`cvvvn; $CellContext`cvvvnscanN = 
       0; $CellContext`cqnscanI = $CellContext`cqn; $CellContext`cqnscanF = \
$CellContext`cqn; $CellContext`cqnscanN = 
       0; $CellContext`clnscanI = $CellContext`cln; $CellContext`clnscanF = \
$CellContext`cln; $CellContext`clnscanN = 
       0; $CellContext`cq3nscanI = $CellContext`cq3n; $CellContext`cq3nscanF = \
$CellContext`cq3n; $CellContext`cq3nscanN = 
       0; $CellContext`cl3nscanI = $CellContext`cl3n; $CellContext`cl3nscanF = \
$CellContext`cl3n; $CellContext`cl3nscanN = 
       0; $CellContext`totnumberofpoints8 = 
       1; $CellContext`totnumberofpoints13 = 
       1; $CellContext`totnumberofpoints14 = 
       1; $CellContext`totnumberofpoints100 = 1; $CellContext`cvvw[
...
$CellContext`MZn^2 - 2 Sqrt[2] $CellContext`\[Alpha]EWn Pi)]) + 
              6 Sqrt[$CellContext`Gfn^9 $CellContext`MZn^26 ($CellContext`Gfn \
$CellContext`MZn^2 - 2 Sqrt[2] $CellContext`\[Alpha]EWn 
...
$CellContext`MZn^2 - 2 Sqrt[2] $CellContext`\[Alpha]EWn Pi)] + 
             Sqrt[2] 
              Sqrt[$CellContext`Gfn^7 $CellContext`MZn^14 ($CellContext`Gfn \
$CellContext`MZn^2 - 2 Sqrt[2] $CellContext`\[Alpha]EWn Pi)] - 
             8 $CellContext`\[Alpha]EWn $CellContext`Gfn^3 $CellContext`MZn^6 
...
$CellContext`cNn $CellContext`cwtn $CellContext`gwn^2 ($CellContext`MVzn^4 + 
            ...
            6 (
              1 + $CellContext`cvvwn) $CellContext`MWn^4) $CellContext`sCn \
...
($CellContext`VzWWWidthnum/$CellContext`MVzn) 48 
 ...
 CellChangeTimes->{3.793600594859519*^9, 3.793613180959773*^9, 
  3.793614067608172*^9, 3.8229775071924257`*^9, 3.822978363998349*^9, 
  3.822979544647163*^9},
 CellLabel->"Out[17]=",ExpressionUUID->"55878c37-469b-4109-8715-9c41843384bc"],
...
\\(c\\), \\(q3\\)]\\),\\!\\(\\*SubscriptBox[\\(c\\), \\(l3\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`constraincqcl = False; $CellContext`cqn = 
         1; $CellContext`cln = 1; $CellContext`cq3n = 1; $CellContext`cl3n = 
         1; $CellContext`cqnscanI = $CellContext`cqn; $CellContext`clnscanI = \
$CellContext`cln; $CellContext`cq3nscanI = $CellContext`cq3n; \
$CellContext`cl3nscanI = $CellContext`cl3n; $CellContext`cqnscanF = \
$CellContext`cqn; $CellContext`clnscanF = $CellContext`cln; \
$CellContext`cq3nscanF = $CellContext`cq3n; $CellContext`cl3nscanF = \
$CellContext`cl3n; $CellContext`cqnscanN = 0; $CellContext`clnscanN = 
         0; $CellContext`cq3nscanN = 0; $CellContext`cl3nscanN = 0),
       Evaluator->Automatic,
       Method->"Queued"], 
      ButtonBox[
...
\\(l3\\)]\\)=\\!\\(\\*SubscriptBox[\\(c\\), \\(F\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`cln := $CellContext`cqn; $CellContext`cq3n := \
$CellContext`cqn; $CellContext`cl3n := $CellContext`cqn; \
$CellContext`clnscanI := $CellContext`cqnscanI; $CellContext`cq3nscanI := \
$CellContext`cqnscanI; $CellContext`cl3nscanI := $CellContext`cqnscanI; \
$CellContext`clnscanF := $CellContext`cqnscanF; $CellContext`cq3nscanF := \
$CellContext`cqnscanF; $CellContext`cl3nscanF := $CellContext`cqnscanF; \
$CellContext`clnscanN := $CellContext`cqnscanN; $CellContext`cq3nscanN := \
$CellContext`cqnscanN; $CellContext`cl3nscanN := $CellContext`cqnscanN),
       Evaluator->Automatic,
       Method->"Queued"]},
     {
      ButtonBox[
...
\\(q3\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`cq3n = $CellContext`cq3n; $CellContext`cln = \
$CellContext`cln; $CellContext`cl3n := $CellContext`cln; \
$CellContext`cq3nscanI = $CellContext`cq3nscanI; $CellContext`clnscanI = \
$CellContext`clnscanI; $CellContext`cl3nscanI := $CellContext`clnscanI; \
$CellContext`cq3nscanF = $CellContext`cq3nscanF; $CellContext`clnscanF = \
$CellContext`cq3nscanF; $CellContext`cl3nscanF := $CellContext`clnscanF; \
$CellContext`cq3nscanN = $CellContext`cq3nscanN; $CellContext`clnscanN = \
$CellContext`clnscanN; $CellContext`cl3nscanN := $CellContext`clnscanN),
       Evaluator->Automatic,
       Method->"Queued"], 
      ButtonBox[
       StyleBox["\<\"Constrain \\!\\(\\*SubscriptBox[\\(c\\), \
...
\\(l3\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`constraincqcl = 
         False; $CellContext`cq3n := $CellContext`cqn; $CellContext`cln = \
$CellContext`cln; $CellContext`cl3n = $CellContext`cl3n; \
$CellContext`cq3nscanI := $CellContext`cqnscanI; $CellContext`clnscanI = \
$CellContext`clnscanI; $CellContext`cl3nscanI = $CellContext`cl3nscanI; \
$CellContext`cq3nscanF := $CellContext`cqnscanF; $CellContext`clnscanF = \
$CellContext`clnscanF; $CellContext`cl3nscanF = $CellContext`cl3nscanF; \
$CellContext`cq3nscanN := $CellContext`cqnscanN; $CellContext`clnscanN = \
$CellContext`clnscanN; $CellContext`cl3nscanN = $CellContext`cl3nscanN),
       Evaluator->Automatic,
       Method->"Queued"]},
     {
      ButtonBox[
...
\\(q\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`cln = $CellContext`cln; $CellContext`cl3n := \
$CellContext`cln; $CellContext`cq3n := $CellContext`cqn; \
$CellContext`clnscanI = $CellContext`clnscanI; $CellContext`cl3nscanI := \
$CellContext`clnscanI; $CellContext`cq3nscanI := $CellContext`cqnscanI; \
$CellContext`clnscanF = $CellContext`clnscanF; $CellContext`cl3nscanF := \
$CellContext`clnscanF; $CellContext`cq3nscanF := $CellContext`cqnscanF; \
$CellContext`clnscanN = $CellContext`clnscanN; $CellContext`cq3nscanN := \
$CellContext`cqnscanN; $CellContext`cl3nscanN := $CellContext`clnscanN),
       Evaluator->Automatic,
       Method->"Queued"], 
      ButtonBox[
...
\\(l3\\)]\\)=\\!\\(\\*SubscriptBox[\\(c\\), \\(q3\\)]\\)\"\>",
       ...
       ButtonFunction:>($CellContext`constraincF = 
         ...
         False; $CellContext`constrainclcl3 = 
         False; $CellContext`constraincqcl = 
         True; $CellContext`cq3n = $CellContext`cq3n; $CellContext`cln := \
$CellContext`cqn; $CellContext`cl3n := $CellContext`cq3n; \
$CellContext`cq3nscanI = $CellContext`cq3nscanI; $CellContext`clnscanI := \
$CellContext`cqnscanI; $CellContext`cl3nscanI := $CellContext`cq3nscanI; \
$CellContext`cq3nscanF = $CellContext`cq3nscanF; $CellContext`clnscanF := \
$CellContext`cqnscanF; $CellContext`cl3nscanF := $CellContext`cq3nscanF; \
$CellContext`cq3nscanN = $CellContext`cq3nscanN; $CellContext`clnscanN := \
$CellContext`cqnscanN; $CellContext`cl3nscanN := $CellContext`cq3nscanN),
       Evaluator->Automatic,
       Method->"Queued"]}
    },
    AutoDelete->False,
 ...
 CellChangeTimes->{
  3.793598585247414*^9, 3.7935986232532873`*^9, {3.793598674113043*^9, 
   ...
   3.793605386947692*^9, 3.793614083810894*^9, 3.822977529296156*^9},
 CellLabel->"Out[22]=",ExpressionUUID->"6426f455-e040-4f28-84ef-c32f52ed77f7"],
...
\(l3\)]\)=\!\(\*SubscriptBox[\(c\), \(q3\)]\)", True, "Please initialize"], 
         TraditionalForm],
        ImageSizeCache->{222., {6., 13.}}],
       StripOnInput->False,
       FontSize->18]}
    },
 ...
 CellChangeTimes->{
  3.82298109458843*^9, {3.822981162201477*^9, 3.822981177004631*^9}, 
   3.822981220802884*^9, {3.8229814605155487`*^9, 3.822981470956555*^9}},
 CellLabel->
  "Out[35]//TableForm=",ExpressionUUID->"b4f3ec28-dd0f-4f67-b993-\
faa335566dd5"],
...
\\\",FontSize->16]\\)\\!\\(\\*StyleBox[\\\"steps\\\",FontSize->16]\\)\"\>"}
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`MVznscanI, 
                 Initialization -> $CellContext`MVzn],
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`MVznscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`gstnscanI, 
                 Initialization -> $CellContext`gstn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`gstnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`chnscanI, 
                 Initialization -> $CellContext`chn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`chnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cqnscanI, 
                 Initialization -> $CellContext`cqn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cqnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`clnscanI, 
                 Initialization -> $CellContext`cln],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`clnscanN, Initialization -> 0],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
                   Not[$CellContext`constraincF], 
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cq3nscanI, 
                 Initialization -> $CellContext`cq3n],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
                   Not[$CellContext`constraincF], 
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cq3nscanN, Initialization -> 0],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
                   Not[$CellContext`constraincF], 
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cl3nscanI, 
                 Initialization -> $CellContext`cl3n],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
                   Not[$CellContext`constraincF], 
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cl3nscanN, Initialization -> 0],
                ContinuousAction->True,
                Enabled->Dynamic[
                  And[
                   Not[$CellContext`constraincF], 
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvwnscanI, 
                 Initialization -> $CellContext`cvvwn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvwnscanF, 
                 Initialization -> $CellContext`cvvwn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvwnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvhhnscanI, 
                 Initialization -> $CellContext`cvvhhn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvhhnscanF, 
                 Initialization -> $CellContext`cvvhhn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvhhnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvvnscanI, 
                 Initialization -> $CellContext`cvvvn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvvnscanF, 
                 Initialization -> $CellContext`cvvvn],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
           ...
           TagBox[GridBox[{
              {
               ...
               InputFieldBox[
                Dynamic[$CellContext`cvvvnscanN, Initialization -> 0],
                ContinuousAction->True]}
             },
             GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
             GridBoxSpacings->{"Columns" -> {
   ...
   Function[BoxForm`e$, 
    TableForm[BoxForm`e$]]], TraditionalForm]], "Output",
 CellChangeTimes->{3.822974021584004*^9, 3.82297766378817*^9},
 CellLabel->
  "Out[25]//TableForm=",ExpressionUUID->"1181a90f-91b0-448c-9fbd-\
93abfce44081"],
...
\\(DY\\)]\\)(\\!\\(\\*SubscriptBox[\\(E\\), \\(CM\\)]\\))\"\>", \
"\<\"\\!\\(\\*SubsuperscriptBox[\\(\[Sigma]\\), \\(0\\), \
\\(DY\\)]\\)(\\!\\(\\*SubscriptBox[\\(E\\), \\(CM\\)]\\))\"\>", \
"\<\"\\!\\(\\*SubsuperscriptBox[\\(\[Sigma]\\), \\(-\\), \
\\(DY\\)]\\)(\\!\\(\\*SubscriptBox[\\(E\\), \\(CM\\)]\\))\"\>", \
"\<\"\\!\\(\\*SubsuperscriptBox[\\(\[Sigma]\\), \\(+\\), \\(VBF\\)]\\)(\\!\\(\
\\*SubscriptBox[\\(E\\), \\(CM\\)]\\))\"\>", "\<\"\\!\\(\\*SubsuperscriptBox[\
\\(\[Sigma]\\), \\(0\\), \\(VBF\\)]\\)(\\!\\(\\*SubscriptBox[\\(E\\), \
\\(CM\\)]\\))\"\>", "\<\"\\!\\(\\*SubsuperscriptBox[\\(\[Sigma]\\), \\(-\\), \
\\(VBF\\)]\\)(\\!\\(\\*SubscriptBox[\\(E\\), \\(CM\\)]\\))\"\>"}
    },
 ...
 CellChangeTimes->{3.822977686820314*^9},
 CellLabel->"Out[28]=",ExpressionUUID->"8a87318c-18e4-481d-a7a6-207ef88f7522"],
       ...
       ButtonFunction:>($CellContext`outputfile = 
         SystemDialogInput[
          "Directory", WindowTitle -> 
           ...
           ".csv"]; $CellContext`MVznstep = If[
           
           And[$CellContext`MVznscanN != 
            0, $CellContext`MVznscanF - $CellContext`MVznscanI != 
            0], ($CellContext`MVznscanF - \
$CellContext`MVznscanI)/$CellContext`MVznscanN, $CellContext`MVzn]; \
$CellContext`gstnstep = If[
           
           And[$CellContext`gstnscanN != 
            0, $CellContext`gstnscanF - $CellContext`gstnscanI != 
            0], ($CellContext`gstnscanF - \
$CellContext`gstnscanI)/$CellContext`gstnscanN, $CellContext`MVzn]; \
$CellContext`chnstep = If[
           
           And[$CellContext`chnscanN != 
            0, $CellContext`chnscanF - $CellContext`chnscanI != 
            0], ($CellContext`chnscanF - \
$CellContext`chnscanI)/$CellContext`chnscanN, $CellContext`MVzn]; \
$CellContext`cqnstep = If[
           
           And[$CellContext`cqnscanN != 
            0, $CellContext`cqnscanF - $CellContext`cqnscanI != 
            0], ($CellContext`cqnscanF - \
$CellContext`cqnscanI)/$CellContext`cqnscanN, $CellContext`MVzn]; \
$CellContext`clnstep = If[
           
           And[$CellContext`clnscanN != 
            0, $CellContext`clnscanF - $CellContext`clnscanI != 
            0], ($CellContext`clnscanF - \
$CellContext`clnscanI)/$CellContext`clnscanN, $CellContext`MVzn]; \
$CellContext`cq3nstep = If[
           
           And[$CellContext`cq3nscanN != 
            0, $CellContext`cq3nscanF - $CellContext`cq3nscanI != 
            0], ($CellContext`cq3nscanF - \
$CellContext`cq3nscanI)/$CellContext`cq3nscanN, $CellContext`MVzn]; \
$CellContext`cl3nstep = If[
           
           And[$CellContext`cl3nscanN != 
            0, $CellContext`cl3nscanF - $CellContext`cl3nscanI != 
            
            0], ($CellContext`cl3nscanF - \
$CellContext`cl3nscanI)/$CellContext`cl3nscanN, $CellContext`MVzn]; \
$CellContext`cvvwnstep = If[
           
           And[$CellContext`cvvwnscanN != 
            0, $CellContext`cvvwnscanF - $CellContext`cvvwnscanI != 
            0], ($CellContext`cvvwnscanF - \
$CellContext`cvvwnscanI)/$CellContext`cvvwnscanN, $CellContext`MVzn]; \
$CellContext`cvvhhnstep = If[
           
           And[$CellContext`cvvhhnscanN != 
            0, $CellContext`cvvhhnscanF - $CellContext`cvvhhnscanI != 
            0], ($CellContext`cvvhhnscanF - \
$CellContext`cvvhhnscanI)/$CellContext`cvvhhnscanN, $CellContext`MVzn]; \
$CellContext`cvvvnstep = If[
           
           And[$CellContext`cvvvnscanN != 
            0, $CellContext`cvvvnscanF - $CellContext`cvvvnscanI != 
            0], ($CellContext`cvvvnscanF - \
$CellContext`cvvvnscanI)/$CellContext`cvvvnscanN, $CellContext`MVzn]; \
$CellContext`totnumberofpoints8 = Which[
           ...
           Apply[Times, 
            ...
            DeleteCases[{($CellContext`MVznscanF - \
$CellContext`MVznscanI)/$CellContext`MVznstep + 
              1, ($CellContext`gstnscanF - \
$CellContext`gstnscanI)/$CellContext`gstnstep + 
              1, ($CellContext`chnscanF - \
$CellContext`chnscanI)/$CellContext`chnstep + 
              1, ($CellContext`cqnscanF - \
$CellContext`cqnscanI)/$CellContext`cqnstep + 
              1, ($CellContext`clnscanF - \
$CellContext`clnscanI)/$CellContext`clnstep + 
              1, ($CellContext`cq3nscanF - \
$CellContext`cq3nscanI)/$CellContext`cq3nstep + 
              1, ($CellContext`cl3nscanF - \
$CellContext`cl3nscanI)/$CellContext`cl3nstep + 
              1, ($CellContext`cvvwnscanF - \
$CellContext`cvvwnscanI)/$CellContext`cvvwnstep + 
              1, ($CellContext`cvvhhnscanF - \
$CellContext`cvvhhnscanI)/$CellContext`cvvhhnstep + 
              1, ($CellContext`cvvvnscanF - \
$CellContext`cvvvnscanI)/$CellContext`cvvvnstep + 1}, 1]], 
...
$CellContext`cvvhhnscanI)/$CellContext`cvvhhnstep + 
              1, ($CellContext`cvvvnscanF - \
$CellContext`cvvvnscanI)/$CellContext`cvvvnstep + 1}, 
...
$CellContext`indicator8 = 0; Which[
          ...
          For[$CellContext`MVzn = $CellContext`MVznscanI, $CellContext`MVzn <= \
$CellContext`MVznscanF, 
           AddTo[$CellContext`MVzn, $CellContext`MVznstep], 
           
           For[$CellContext`gstn = $CellContext`gstnscanI, $CellContext`gstn <= \
$CellContext`gstnscanF, 
            AddTo[$CellContext`gstn, $CellContext`gstnstep], 
            
            For[$CellContext`chn = $CellContext`chnscanI, $CellContext`chn <= \
$CellContext`chnscanF, 
             AddTo[$CellContext`chn, $CellContext`chnstep], 
             
             For[$CellContext`cqn = $CellContext`cqnscanI, $CellContext`cqn <= \
$CellContext`cqnscanF, 
              AddTo[$CellContext`cqn, $CellContext`cqnstep], 
              
              For[$CellContext`cln = $CellContext`clnscanI, $CellContext`cln <= \
$CellContext`clnscanF, 
               AddTo[$CellContext`cln, $CellContext`clnstep], 
               
               For[$CellContext`cq3n = $CellContext`cq3nscanI, \
$CellContext`cq3n <= $CellContext`cq3nscanF, 
                AddTo[$CellContext`cq3n, $CellContext`cq3nstep], 
                
                For[$CellContext`cl3n = $CellContext`cl3nscanI, \
$CellContext`cl3n <= $CellContext`cl3nscanF, 
                 AddTo[$CellContext`cl3n, $CellContext`cl3nstep], 
                 
                 For[$CellContext`cvvwn = $CellContext`cvvwnscanI, \
$CellContext`cvvwn <= $CellContext`cvvwnscanF, 
                  AddTo[$CellContext`cvvwn, $CellContext`cvvwnstep], 
                  
                  For[$CellContext`cvvhhn = $CellContext`cvvhhnscanI, \
$CellContext`cvvhhn <= $CellContext`cvvhhnscanF, 
                   AddTo[$CellContext`cvvhhn, $CellContext`cvvhhnstep], 
                   
                   For[$CellContext`cvvvn = $CellContext`cvvvnscanI, \
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                    
                    AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`gwn = Chop[$CellContext`gwnum]; $CellContext`vvn = 
                    Chop[$CellContext`vvnum]; $CellContext`mVn = 
                    Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                    Chop[$CellContext`mVtnum]; $CellContext`zetan = 
                    Chop[$CellContext`zetanum]; $CellContext`swtn = 
                    Chop[$CellContext`swtnum]; $CellContext`cwtn = 
                    Chop[$CellContext`cwtnum]; $CellContext`twtn = 
                    Chop[$CellContext`twtnum]; $CellContext`gzn = 
                    Chop[$CellContext`gznum]; $CellContext`g1n = 
                    Chop[$CellContext`g1num]; $CellContext`MWtn = 
                    Chop[$CellContext`MWtnum]; $CellContext`MZtn = 
                    Chop[$CellContext`MZtnum]; $CellContext`\[Theta]Cn = 
                    Chop[$CellContext`\[Theta]Cnum]; $CellContext`sCn = 
                    Chop[$CellContext`sCnum]; $CellContext`cCn = 
                    Chop[$CellContext`cCnum]; $CellContext`\[Theta]Nn = 
                    Chop[$CellContext`\[Theta]Nnum]; $CellContext`sNn = 
                    Chop[$CellContext`sNnum]; $CellContext`cNn = 
                    Chop[$CellContext`cNnum]; $CellContext`MWn = 
                    Chop[$CellContext`MWnum]; $CellContext`MVcn = 
                    Chop[$CellContext`MVcnum]; $CellContext`Shatn = 
                    Chop[$CellContext`Shatnum]; $CellContext`GfExactn = 
                    Chop[$CellContext`GfExactnum]; $CellContext`VzTotWidthn = 
...
$CellContext`CSVmDY8TeVnum, $CellContext`CSVpVBF8TeVnum, \
$CellContext`CSV0VBF8TeVnum, $CellContext`CSVmVBF8TeVnum}]]; \
$CellContext`indicator8 = $CellContext`indicator8 + 1]]]]]]]]]], 
...
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                 ...
                 AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`cln = Chop[$CellContext`cqn]; $CellContext`cq3n = 
                  Chop[$CellContext`cqn]; $CellContext`cl3n = 
                  Chop[$CellContext`cqn]; $CellContext`gwn = 
                  Chop[$CellContext`gwnum]; $CellContext`vvn = 
                  Chop[$CellContext`vvnum]; $CellContext`mVn = 
                  Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                  Chop[$CellContext`mVtnum]; $CellContext`zetan = 
                  Chop[$CellContext`zetanum]; $CellContext`swtn = 
...
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                   ...
                   AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`cq3n = Chop[$CellContext`cqn]; $CellContext`gwn = 
                    Chop[$CellContext`gwnum]; $CellContext`vvn = 
                    Chop[$CellContext`vvnum]; $CellContext`mVn = 
                    Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                    Chop[$CellContext`mVtnum]; $CellContext`zetan = 
...
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                   ...
                   AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`cl3n = Chop[$CellContext`cln]; $CellContext`gwn = 
                    Chop[$CellContext`gwnum]; $CellContext`vvn = 
                    Chop[$CellContext`vvnum]; $CellContext`mVn = 
                    Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                    Chop[$CellContext`mVtnum]; $CellContext`zetan = 
...
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                  ...
                  AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`cq3n = Chop[$CellContext`cqn]; $CellContext`cl3n = 
                   Chop[$CellContext`cln]; $CellContext`gwn = 
                   Chop[$CellContext`gwnum]; $CellContext`vvn = 
                   Chop[$CellContext`vvnum]; $CellContext`mVn = 
                   Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                   Chop[$CellContext`mVtnum]; $CellContext`zetan = 
...
$CellContext`cvvvn <= $CellContext`cvvvnscanF, 
                  ...
                  AddTo[$CellContext`cvvvn, $CellContext`cvvvnstep], \
$CellContext`cln = Chop[$CellContext`cqn]; $CellContext`cl3n = 
                   Chop[$CellContext`cq3n]; $CellContext`gwn = 
                   Chop[$CellContext`gwnum]; $CellContext`vvn = 
                   Chop[$CellContext`vvnum]; $CellContext`mVn = 
                   Chop[$CellContext`mVnum]; $CellContext`mVtn = 
                   Chop[$CellContext`mVtnum]; $CellContext`zetan = 
...
$CellContext`CSVmDY8TeVnum, $CellContext`CSVpVBF8TeVnum, \
$CellContext`CSV0VBF8TeVnum, $CellContext`CSVmVBF8TeVnum}]]; \
$CellContext`indicator8 = $CellContext`indicator8 + 
                    1]]]]]]]]]; $CellContext`ScanResultTableToPrint8 = 
...
$CellContext`CSVmDY13TeVnum, $CellContext`CSVpVBF13TeVnum, \
$CellContext`CSV0VBF13TeVnum, $CellContext`CSVmVBF13TeVnum}]]; \
$CellContext`indicator13 = $CellContext`indicator13 + 1]]]]]]]]]], 
          And[$CellContext`constraincF, 
           Not[$CellContext`constraincqcq3], 
           Not[$CellContext`constrainclcl3], 
           Not[$CellContext`constraincqcl]], 
...
$CellContext`CSVmDY13TeVnum, $CellContext`CSVpVBF13TeVnum, \
$CellContext`CSV0VBF13TeVnum, $CellContext`CSVmVBF13TeVnum}]]; \
$CellContext`indicator13 = $CellContext`indicator13 + 
                    1]]]]]]]]]; $CellContext`ScanResultTableToPrint13 = 
...
$CellContext`CSVmDY14TeVnum, $CellContext`CSVpVBF14TeVnum, \
$CellContext`CSV0VBF14TeVnum, $CellContext`CSVmVBF14TeVnum}]]; \
$CellContext`indicator14 = $CellContext`indicator14 + 1]]]]]]]]]], 
          And[$CellContext`constraincF, 
           Not[$CellContext`constraincqcq3], 
           Not[$CellContext`constrainclcl3], 
           Not[$CellContext`constraincqcl]], 
...
$CellContext`CSVmDY14TeVnum, $CellContext`CSVpVBF14TeVnum, \
$CellContext`CSV0VBF14TeVnum, $CellContext`CSVmVBF14TeVnum}]]; \
$CellContext`indicator14 = $CellContext`indicator14 + 
                    1]]]]]]]]]; $CellContext`ScanResultTableToPrint14 = 
...
$CellContext`CSVmDY100TeVnum, $CellContext`CSVpVBF100TeVnum, \
$CellContext`CSV0VBF100TeVnum, $CellContext`CSVmVBF100TeVnum}]]; \
$CellContext`indicator100 = $CellContext`indicator100 + 1]]]]]]]]]], 
          And[$CellContext`constraincF, 
           Not[$CellContext`constraincqcq3], 
           Not[$CellContext`constrainclcl3], 
           Not[$CellContext`constraincqcl]], 
...
$CellContext`CSVmDY100TeVnum, $CellContext`CSVpVBF100TeVnum, \
$CellContext`CSV0VBF100TeVnum, $CellContext`CSVmVBF100TeVnum}]]; \
$CellContext`indicator100 = $CellContext`indicator100 + 
      ...
      ProgressIndicatorBox[Dynamic[$CellContext`indicator8], {1, 
        Dynamic[
         If[
          ...
          ValueQ[$CellContext`totnumberofpoints8], \
$CellContext`totnumberofpoints8, 10]]}], 
      ProgressIndicatorBox[Dynamic[$CellContext`indicator13], {1, 
        Dynamic[
         If[
          
          ValueQ[$CellContext`totnumberofpoints13], \
$CellContext`totnumberofpoints13, 10]]}], 
      ProgressIndicatorBox[Dynamic[$CellContext`indicator14], {1, 
        Dynamic[
         If[
          
          ValueQ[$CellContext`totnumberofpoints14], \
$CellContext`totnumberofpoints14, 10]]}], 
      ProgressIndicatorBox[Dynamic[$CellContext`indicator100], {1, 
        Dynamic[
         If[
          
          ValueQ[$CellContext`totnumberofpoints100], \
$CellContext`totnumberofpoints100, 10]]}]},
     {
      TagBox[GridBox[{
         {
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints8], \
$CellContext`indicator8, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints8], \
$CellContext`totnumberofpoints8, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints13], \
$CellContext`indicator13, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints13], \
$CellContext`totnumberofpoints13, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints14], \
$CellContext`indicator14, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints14], \
$CellContext`totnumberofpoints14, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints100], \
$CellContext`indicator100, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
          ...
          TagBox[GridBox[{
             {
              DynamicBox[ToBoxes[
                If[
                 ...
                 ValueQ[$CellContext`totnumberofpoints100], \
$CellContext`totnumberofpoints100, "#"], TraditionalForm],
               ImageSizeCache->{9., {0., 8.}}]}
            },
            GridBoxAlignment->{"Columns" -> {{Left}}, "Rows" -> {{Baseline}}},
   ...
   "Grid"], TraditionalForm]], "Output",
 CellChangeTimes->{
  3.8229774162467318`*^9, 3.8229777090865993`*^9, 3.822977818958591*^9, 
   3.8229780214447393`*^9, 3.8229780607742233`*^9, 3.8229784988181553`*^9, 
   3.8229786883967123`*^9, 3.8229787318099127`*^9, 3.8229787906471767`*^9, 
   3.822978951881218*^9, 3.8229790049440804`*^9, 3.822979107184908*^9, 
   3.822979206378174*^9, {3.822979480211413*^9, 3.822979502292433*^9}},
 CellLabel->"Out[16]=",ExpressionUUID->"ff9fba2a-c696-4c81-b2df-703847b25888"]
}, Open  ]]
},
...
ExpressionUUID->"e41c3b4f-c407-4618-b8e4-cd9491e0890d"
]
...
Cell[3151, 71, 384109, 6620, 56, "Output",ExpressionUUID->"55878c37-469b-4109-8715-9c41843384bc"],
Cell[387263, 6693, 308, 6, 38, "Text",ExpressionUUID->"05240e34-4b5f-4e9e-9636-48988dd2db4b"],
Cell[387574, 6701, 1963, 41, 93, "Text",ExpressionUUID->"2077518f-b221-4272-83ad-031b3620f3c1"],
Cell[389540, 6744, 308, 6, 38, "Text",ExpressionUUID->"d074fd18-04db-4312-b8c6-f8b6af8a564f"],
Cell[389851, 6752, 7923, 149, 138, "Output",ExpressionUUID->"6426f455-e040-4f28-84ef-c32f52ed77f7"],
Cell[397777, 6903, 3338, 72, 49, "Output",ExpressionUUID->"b4f3ec28-dd0f-4f67-b993-faa335566dd5"],
Cell[401118, 6977, 27046, 670, 327, "Output",ExpressionUUID->"1181a90f-91b0-448c-9fbd-93abfce44081"],
Cell[428167, 7649, 308, 6, 38, "Text",ExpressionUUID->"3166b3d1-f54e-493e-8d1f-62fdeb323915"],
Cell[428478, 7657, 1740, 35, 89, "Text",ExpressionUUID->"309127c4-d337-4df5-82c8-65f87ce2f74e"],
Cell[430221, 7694, 3740, 63, 38, "Output",ExpressionUUID->"8a87318c-18e4-481d-a7a6-207ef88f7522"],
Cell[433964, 7759, 324, 6, 38, "Text",ExpressionUUID->"b32d1a0b-4851-4c3e-84c9-dd5d7c1f3ef1"],
Cell[434291, 7767, 295, 5, 35, "Text",ExpressionUUID->"30adbbed-0345-4b9e-a7ae-1ccdd50690ff"],
Cell[434589, 7774, 163393, 3182, 92, "Output",ExpressionUUID->"ff9fba2a-c696-4c81-b2df-703847b25888"]
}, Open  ]]
}
]
*)

(* NotebookSignature tupxqWRZ0g2EoBg4w#QtE18G *)
